...
def main() -> int:
    ...
    old_learning_dir = bridge.LEARNING_DIR
    old_learning_candidates_dir = bridge.LEARNING_CANDIDATES_DIR
    old_learning_proposals_dir = bridge.LEARNING_PROPOSALS_DIR
    old_learning_registry_dir = bridge.LEARNING_REGISTRY_DIR
    old_learning_rejected_dir = bridge.LEARNING_REJECTED_DIR
    old_learning_deferred_dir = bridge.LEARNING_DEFERRED_DIR
    old_learning_packages_dir = bridge.LEARNING_PACKAGES_DIR
    old_learning_logs_dir = bridge.LEARNING_LOGS_DIR
    ...
    try:
        ...
        bridge.LEARNING_DIR = old_learning_dir
        bridge.LEARNING_CANDIDATES_DIR = old_learning_candidates_dir
        bridge.LEARNING_PROPOSALS_DIR = old_learning_proposals_dir
        bridge.LEARNING_REGISTRY_DIR = old_learning_registry_dir
        bridge.LEARNING_REJECTED_DIR = old_learning_rejected_dir
        bridge.LEARNING_DEFERRED_DIR = old_learning_deferred_dir
        bridge.LEARNING_PACKAGES_DIR = old_learning_packages_dir
        bridge.LEARNING_LOGS_DIR = old_learning_logs_dir
