...
TOOL_REGISTRY = [
    ...
    },
    {
        ...
        "risk": "medium",
        "mode": "owner approved 2026-06-11: loopback server + ledger-artifact ingestion (sensitive-scan gated); MCP connect still deferred",
        "next_allowed": "start server per contract, then scripts/memory_sync.py --dry-run, then --ingest",
    ...
    },
    {
        ...
        "next_allowed": "run tools-lab/benchmarks/headroom_offline_benchmark.py on real payloads; H1 shadow mode pending go/no-go (>=30% savings, 100% critical-field retention)",
    ...
    },
    {
        ...
        "risk": "high",
        "mode": "owner approved Stage 1 (Way 2) 2026-06-11: isolated fresh profile, CDP 127.0.0.1:9222, local pages only",
        "next_allowed": "run tools-lab/runs/browser_stage1_run.py per runbook; Stage 2 (real profile) needs separate approval",
